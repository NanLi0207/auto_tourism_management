...
def format_booking_line(order: Dict[str, Optional[str]]) -> str:
    """
    将订单信息格式化为标准文本行。

    格式：
        aYYMMDD Country Count Name GroupName [Language] Platform Notes: Phone: xxx Hotel: xxx [Boat: 包船/不包船]
